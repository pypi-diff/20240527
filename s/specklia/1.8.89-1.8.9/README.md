# Comparing `tmp/specklia-1.8.89.tar.gz` & `tmp/specklia-1.8.9.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "specklia-1.8.89.tar", last modified: Mon May 27 02:54:54 2024, max compression
+gzip compressed data, was "specklia-1.8.9.tar", last modified: Wed Feb 28 15:11:11 2024, max compression
```

## Comparing `specklia-1.8.89.tar` & `specklia-1.8.9.tar`

### file list

```diff
@@ -1,21 +1,21 @@
-drwxr-xr-x   0 root         (0) root         (0)        0 2024-05-27 02:54:54.203621 specklia-1.8.89/
--rw-r--r--   0 root         (0) root         (0)     1061 2024-05-27 02:54:51.000000 specklia-1.8.89/LICENCE
--rw-r--r--   0 root         (0) root         (0)     2898 2024-05-27 02:54:54.203621 specklia-1.8.89/PKG-INFO
--rw-r--r--   0 root         (0) root         (0)     1611 2024-05-27 02:54:51.000000 specklia-1.8.89/README.md
--rw-r--r--   0 root         (0) root         (0)      484 2024-05-27 02:54:54.203621 specklia-1.8.89/setup.cfg
--rw-r--r--   0 root         (0) root         (0)     2366 2024-05-27 02:54:51.000000 specklia-1.8.89/setup.py
-drwxr-xr-x   0 root         (0) root         (0)        0 2024-05-27 02:54:54.203621 specklia-1.8.89/specklia/
--rw-r--r--   0 root         (0) root         (0)       51 2024-05-27 02:54:51.000000 specklia-1.8.89/specklia/__init__.py
--rw-r--r--   0 root         (0) root         (0)    14714 2024-05-27 02:54:51.000000 specklia-1.8.89/specklia/_websocket_helpers.py
--rw-r--r--   0 root         (0) root         (0)    40528 2024-05-27 02:54:51.000000 specklia-1.8.89/specklia/client.py
--rw-r--r--   0 root         (0) root         (0)     4074 2024-05-27 02:54:51.000000 specklia-1.8.89/specklia/utilities.py
-drwxr-xr-x   0 root         (0) root         (0)        0 2024-05-27 02:54:54.203621 specklia-1.8.89/specklia.egg-info/
--rw-r--r--   0 root         (0) root         (0)     2898 2024-05-27 02:54:54.000000 specklia-1.8.89/specklia.egg-info/PKG-INFO
--rw-r--r--   0 root         (0) root         (0)      365 2024-05-27 02:54:54.000000 specklia-1.8.89/specklia.egg-info/SOURCES.txt
--rw-r--r--   0 root         (0) root         (0)        1 2024-05-27 02:54:54.000000 specklia-1.8.89/specklia.egg-info/dependency_links.txt
--rw-r--r--   0 root         (0) root         (0)       80 2024-05-27 02:54:54.000000 specklia-1.8.89/specklia.egg-info/requires.txt
--rw-r--r--   0 root         (0) root         (0)        9 2024-05-27 02:54:54.000000 specklia-1.8.89/specklia.egg-info/top_level.txt
-drwxr-xr-x   0 root         (0) root         (0)        0 2024-05-27 02:54:54.203621 specklia-1.8.89/tests/
--rw-r--r--   0 root         (0) root         (0)    14689 2024-05-27 02:54:51.000000 specklia-1.8.89/tests/test_client.py
--rw-r--r--   0 root         (0) root         (0)     2654 2024-05-27 02:54:51.000000 specklia-1.8.89/tests/test_utilities.py
--rw-r--r--   0 root         (0) root         (0)    11623 2024-05-27 02:54:51.000000 specklia-1.8.89/tests/test_websocket_helpers.py
...
### Comparing `specklia-1.8.89/LICENCE` & `specklia-1.8.9/LICENCE`

 * *Files identical despite different names*

### Comparing `specklia-1.8.89/PKG-INFO` & `specklia-1.8.9/PKG-INFO`
...
### Comparing `specklia-1.8.89/README.md` & `specklia-1.8.9/README.md`

 * *Files identical despite different names*

### Comparing `specklia-1.8.89/setup.py` & `specklia-1.8.9/setup.py`

 * *Files identical despite different names*

### Comparing `specklia-1.8.89/specklia/_websocket_helpers.py` & `specklia-1.8.9/specklia/_websocket_helpers.py`
...
### Comparing `specklia-1.8.89/specklia/client.py` & `specklia-1.8.9/specklia/client.py`
...
### Comparing `specklia-1.8.89/specklia/utilities.py` & `specklia-1.8.9/specklia/utilities.py`
...
### Comparing `specklia-1.8.89/specklia.egg-info/PKG-INFO` & `specklia-1.8.9/specklia.egg-info/PKG-INFO`
...
### Comparing `specklia-1.8.89/tests/test_client.py` & `specklia-1.8.9/tests/test_client.py`
...
### Comparing `specklia-1.8.89/tests/test_utilities.py` & `specklia-1.8.9/tests/test_utilities.py`

 * *Files identical despite different names*

### Comparing `specklia-1.8.89/tests/test_websocket_helpers.py` & `specklia-1.8.9/tests/test_websocket_helpers.py`
