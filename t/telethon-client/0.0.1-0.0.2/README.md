# Comparing `tmp/telethon-client-0.0.1.tar.gz` & `tmp/telethon-client-0.0.2.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "telethon-client-0.0.1.tar", last modified: Mon May 27 11:09:10 2024, max compression
+gzip compressed data, was "telethon-client-0.0.2.tar", last modified: Mon May 27 11:22:15 2024, max compression
```

## Comparing `telethon-client-0.0.1.tar` & `telethon-client-0.0.2.tar`

### file list

```diff
@@ -1,12 +1,16 @@
-drwxrwxrwx   0        0        0        0 2024-05-27 11:09:10.902298 telethon-client-0.0.1/
--rw-rw-rw-   0        0        0      408 2024-05-27 11:09:10.901049 telethon-client-0.0.1/PKG-INFO
--rw-rw-rw-   0        0        0       26 2024-05-27 11:03:45.000000 telethon-client-0.0.1/README.md
--rw-rw-rw-   0        0        0       97 2024-05-27 11:08:09.000000 telethon-client-0.0.1/pyproject.toml
--rw-rw-rw-   0        0        0       42 2024-05-27 11:09:10.902298 telethon-client-0.0.1/setup.cfg
--rw-rw-rw-   0        0        0      626 2024-05-27 11:07:28.000000 telethon-client-0.0.1/setup.py
-drwxrwxrwx   0        0        0        0 2024-05-27 11:09:10.901049 telethon-client-0.0.1/telethon_client.egg-info/
--rw-rw-rw-   0        0        0      408 2024-05-27 11:09:10.000000 telethon-client-0.0.1/telethon_client.egg-info/PKG-INFO
--rw-rw-rw-   0        0        0      227 2024-05-27 11:09:10.000000 telethon-client-0.0.1/telethon_client.egg-info/SOURCES.txt
--rw-rw-rw-   0        0        0        1 2024-05-27 11:09:10.000000 telethon-client-0.0.1/telethon_client.egg-info/dependency_links.txt
--rw-rw-rw-   0        0        0       17 2024-05-27 11:09:10.000000 telethon-client-0.0.1/telethon_client.egg-info/requires.txt
--rw-rw-rw-   0        0        0        1 2024-05-27 11:09:10.000000 telethon-client-0.0.1/telethon_client.egg-info/top_level.txt
...
### Comparing `telethon-client-0.0.1/setup.py` & `telethon-client-0.0.2/setup.py`
