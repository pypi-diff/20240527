# Comparing `tmp/zenaura-0.9.88.tar.gz` & `tmp/zenaura-0.9.89.tar.gz`
...
### Comparing `zenaura-0.9.88/zenaura.egg-info/PKG-INFO` & `zenaura-0.9.89/zenaura.egg-info/PKG-INFO`
