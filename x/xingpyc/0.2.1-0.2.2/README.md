# Comparing `tmp/xingpyc-0.2.1.tar.gz` & `tmp/xingpyc-0.2.2.tar.gz`
...
## Comparing `xingpyc-0.2.1.tar` & `xingpyc-0.2.2.tar`
...
### Comparing `xingpyc-0.2.1/PKG-INFO` & `xingpyc-0.2.2/PKG-INFO`
...
### Comparing `xingpyc-0.2.1/pyproject.toml` & `xingpyc-0.2.2/pyproject.toml`
...
### Comparing `xingpyc-0.2.1/src/xingpyc/__init__.py` & `xingpyc-0.2.2/src/xingpyc/__init__.py`
...
### Comparing `xingpyc-0.2.1/src/xingpyc.egg-info/PKG-INFO` & `xingpyc-0.2.2/src/xingpyc.egg-info/PKG-INFO`
